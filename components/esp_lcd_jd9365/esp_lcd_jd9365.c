 ...
 */
 ...
 /*
  * Upstream generates these from idf_component.yml via cmake_utilities'
  * cu_pkg_define_version(). The vendored copy has no package-manager metadata,
  * so the version is pinned here (upstream esp-iot-solution 1.0.2, JC8012P4A1C
  * official init table).
  */
 #define ESP_LCD_JD9365_VER_MAJOR   1
 #define ESP_LCD_JD9365_VER_MINOR   0
 #define ESP_LCD_JD9365_VER_PATCH   2
 ...
 static const jd9365_lcd_init_cmd_t vendor_specific_init_default[] = {
  {0xE0, (uint8_t[]){0x00}, 1, 0},
    ...
    {0x80, (uint8_t[]){0x01}, 1, 0}, // 03->01 2lane
    ...
    {0x00, (uint8_t[]){0x00}, 1, 120},

    // Display on
    {0x29, (uint8_t[]){0x00}, 1, 0},
    {0x00, (uint8_t[]){0x00}, 1, 20},
 };
