 ...
 * the largest MDI font that fits, mirroring the montserrat tiers above.  If no MDI
 * font with the lightbulb glyph is available, fall back to the montserrat icon font
 * (caller then renders LV_SYMBOL_POWER instead). */
