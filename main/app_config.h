...
#  define APP_NAME               "betta-ha-panel-10jc"
#  define APP_SCREEN_WIDTH       1280
#  define APP_SCREEN_HEIGHT      800
#  define APP_CONTENT_BOX_WIDTH  1280
#  define APP_CONTENT_BOX_HEIGHT 680
...
/* Graphical screensaver: instead of a fully dark panel, show a static image
 * at a low backlight level once the display would otherwise switch off. */
#define APP_DISPLAY_SCREENSAVER_ENABLED 1
#define APP_DISPLAY_SCREENSAVER_BRIGHTNESS_PERCENT 20
#define APP_DISPLAY_SCREENSAVER_CLOCK_ENABLED 1
...
#define APP_TOP_BAR_ROOM_NAME_MAX_LEN 32
...
/* Absolute VFS path to a tile background image (e.g. /sdcard/bg/name.png). */
#define APP_MAX_IMAGE_PATH_LEN 192

/* Comma-separated list of additional entity ids for composite widgets
 * (monitor_tile sub-stats, entity_list rows).  Sized generously so a full
 * docker container / game server / VM list fits in one tile. */
#define APP_MAX_EXTRA_ENTITY_IDS_LEN 1536
#define APP_MAX_MONITOR_SUBS 4
#define APP_MAX_ENTITY_LIST_ROWS 24

/* sensor_tile: labeled rows with optional entities ("GPU=sensor.gpu_temp").
 * Rows with an empty entity are hidden. Sized like entity_list. */
#define APP_MAX_SENSOR_TILE_ROWS 24
#define APP_MAX_SENSOR_TILE_LABEL_LEN 32

#define APP_HA_MAX_ENTITIES 4096
#define APP_HA_MAX_STATES 2048
