...
/* True when the inactivity state machine currently wants the screen OFF and
 * the graphical screensaver is enabled (i.e. the screensaver overlay should be
 * visible on top of the dashboard). */
