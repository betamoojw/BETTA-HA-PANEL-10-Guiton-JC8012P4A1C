...
{
    if (&_binary_index_html_gz_end[0] > &_binary_index_html_gz_start[0]) {
        return send_embedded(req, _binary_index_html_gz_start, _binary_index_html_gz_end, "text/html", false);
    }
...
{
    if (&_binary_app_js_gz_end[0] > &_binary_app_js_gz_start[0]) {
        return send_embedded(req, _binary_app_js_gz_start, _binary_app_js_gz_end, "application/javascript", false);
    }
...
{
    if (&_binary_styles_css_gz_end[0] > &_binary_styles_css_gz_start[0]) {
        return send_embedded(req, _binary_styles_css_gz_start, _binary_styles_css_gz_end, "text/css", false);
    }
