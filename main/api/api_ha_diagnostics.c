...
esp_err_t api_ha_diagnostics_get_handler(httpd_req_t *req)
{
    ...
    cJSON_AddBoolToObject(root, "catalog_done", diag.catalog_done);
    cJSON_AddNumberToObject(root, "catalog_total", (double)diag.catalog_total);
    cJSON_AddNumberToObject(root, "catalog_imported", (double)diag.catalog_imported);
    cJSON_AddNumberToObject(root, "catalog_disabled", (double)diag.catalog_disabled);
