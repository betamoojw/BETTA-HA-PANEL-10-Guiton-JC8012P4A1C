...
| `W gsl3680: Unable to initialize the I2C address`                              | Touch controller probe retry at boot; the driver re-initializes.                    | None if touch works / Nic, jeśli dotyk działa |
